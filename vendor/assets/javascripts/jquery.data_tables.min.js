...
b)]},simple_numbers:function(a,b){return["previous",Ba(a,b),"next"]},full_numbers:function(a,b){return["first","previous",Ba(a,b),"next","last"]},_numbers:Ba,numbers_length:7});h.extend(!0,m.ext.renderer,{pageButton:{_:function(a,b,c,e,d,f){var g=a.oClasses,j=a.oLanguage.oPaginate,i,k,l=0,m=function(b,e){var p,r,s,t,u=function(b){Va(a,b.data.action,true)};p=0;for(r=e.length;p<r;p++){t=e[p];if(h.isArray(t)){s=h("<"+(t.DT_el||"div")+"/>").appendTo(b);m(s,t)}else{i=null;k="";switch(t){case "ellipsis":b.append('<span class="ellipsis">&#x2026;</span>');
